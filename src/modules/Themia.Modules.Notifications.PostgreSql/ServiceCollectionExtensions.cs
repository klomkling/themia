...
/// <summary>DI entry point for the PostgreSQL outbox-claim dialect.</summary>
public static class ServiceCollectionExtensions
{
    /// <summary>
    /// Registers the PostgreSQL <see cref="INotificationsSqlDialect"/>, resolving its connection string
    ...
    public static IServiceCollection AddThemiaNotificationsPostgreSql(
