...
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddThemiaNotificationsMySql(
        this IServiceCollection services, string connectionStringName = "Default")
    {
        ...
        services.TryAddSingleton<INotificationsSqlDialect>(sp =>
        {
            ...
            return new MySqlNotificationsDialect(connectionString);
        });

        services.TryAddSingleton<IOutboxPurgeDialect<ClaimedOutboxRow>, MySqlNotificationsPurgeDialect>();
