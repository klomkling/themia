...
/// <summary>SQL Server retention deletes for the notifications outbox. SQL Server has no
...
/// short.</summary>
internal sealed class SqlServerNotificationsPurgeDialect : IOutboxPurgeDialect<ClaimedOutboxRow>
{
    private const string PurgeSentSql = """
        DELETE TOP (@batch) FROM [notifications].[outbox_messages]
