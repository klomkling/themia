...
public static class ServiceCollectionExtensions
{
        ...
        this IServiceCollection services, string connectionString, Action<ExceptionalOptions> configure)
    {
        ...
        services.TryAddSingleton<IExceptionalSqlDialect>(new SqlServerExceptionalDialect(connectionString));
    ...
    private static void RunMigration(string connectionString)
    {
        ...
        catch (Exception ex)
        {
            throw new InvalidOperationException(
                ...
                "Verify the SQL Server connection string and that the principal has DDL permissions.", ex);
        }
    }
}
