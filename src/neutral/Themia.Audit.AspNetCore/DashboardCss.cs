...
internal static class DashboardCss
{
    internal const string Content = """
        :root{--fg:#24292f;--muted:#57606a;--line:#d0d7de;--bg:#fff;--accent:#0969da;--success:#1a7f37;--failure:#cf222e;--denied:#9a6700}
        ...
        .outcome{font-weight:600}.outcome-success{color:var(--success)}.outcome-failure{color:var(--failure)}.outcome-denied{color:var(--denied)}
