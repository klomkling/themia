...
public sealed class SqlServerIdentityFixture : IAsyncLifetime
{
    ...
    public async Task ResetAsync()
    {
        ...
        command.CommandText =
            "DELETE FROM [identity].external_logins; DELETE FROM [identity].refresh_tokens; DELETE FROM [identity].user_tokens; DELETE FROM [identity].user_claims; DELETE FROM [identity].role_claims; " +
