...
/// <summary>External-login HTTP conformance: Dapper + SQL Server peer.</summary>
[Trait("Category", "Integration")]
public sealed class DapperSqlServerExternalAuthTests(SqlServerAuthFixture fixture)
    : ExternalAuthConformanceTests, IClassFixture<SqlServerAuthFixture>
{
