...
| **Neutral cores** | `net8.0;net10.0` | `Themia.DependencyInjection`, `Themia.Data.Migrations`, `Themia.Data.Probes`, `Themia.Quartz`, `Themia.Totp`, `Themia.WebAuthn`, `Themia.Exceptional(.SqlServer/.MySql/.PostgreSql)`, `Themia.AspNetCore` |
| **Modules** | `net10.0` | `Themia.Modules.Scheduling`, `Themia.Modules.Identity(.Abstractions)`, `Themia.Modules.Identity.AspNetCore`, `Themia.Modules.Storage`, `.Notifications(+3 engines)`, `.Pdf`, `.Export`, `.Audit`, `.Messaging` |
